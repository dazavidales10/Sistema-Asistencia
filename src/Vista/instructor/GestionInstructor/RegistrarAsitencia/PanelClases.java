...
import Vista.instructor.DialogsInstructor.dialogEditarClase;
import Vista.instructor.GestionInstructor.VerAprendices.PanelVerAprendices;
...
public class PanelClases extends JFrame {
    ...
    public PanelClases(
        ...
        btnOcultar.setBackground(new Color(0,180,0));
        btnOcultar.setForeground(Color.WHITE);
        derecha.add(btnOcultar);
        add(derecha,BorderLayout.EAST);
        derecha.add(Box.createVerticalStrut(40));
        ...
        btnBuscar.addActionListener(e -> buscar());
            ...
            btnOcultar.addActionListener(e -> ocultarClase());

            btnEditar.addActionListener(e -> {

                dialogEditarClase dialog =
                        new dialogEditarClase(
                                this,
                                idClaseSeleccionada
                        );
    ...
    private void ocultarClase() {
        ...
        int opcion = JOptionPane.showConfirmDialog(
                this,
                "¿Desea ocultar esta clase?\n\nLa clase no será eliminada, solamente dejará de aparecer.",
                "Confirmar",
        ...
        try (Connection cn = Conexion.conectar();
            ...
            ps.setInt(1, idClaseSeleccionada);
